export const NUTRIWISE_MIDDLEWARE_URL =
  "https://keen-ram-worthy.ngrok-free.app/"; // "https://keen-ram-worthy.ngrok-free.app";

export const DEFAULT_PIC =
  "https://ia801703.us.archive.org/6/items/twitter-default-pfp/e.png";

export const LOGO = "https://i.imgur.com/aZjVWFp.png";

export const MIN_MEALS_LIMIT = 10;
export const MAX_MEALS_LIMIT = 40;

export const MIN_COOKING_TIME = 5;
export const MAX_COOKING_TIME = 60;
...
export const mealCookingMethods = [
